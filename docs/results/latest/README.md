...
![Net worth](images/01_net_worth.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Financial net worth

![Financial net worth](images/02_financial_net_worth.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Liquid wealth

![Liquid wealth](images/03_liquid_wealth.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Cash

![Cash](images/04_cash.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Retirement

![Retirement](images/05_retirement.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Debt

![Debt](images/06_debt.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Brokerage

![Brokerage](images/07_brokerage.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Home equity

![Home equity](images/08_home_equity.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Earned income

![Earned income](images/09_earned_income.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Childcare

![Childcare](images/10_childcare.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Health premium

![Health premium](images/11_health_premium.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Tax expense

![Tax expense](images/12_tax_expense.png)

Predictive bands for scenario 64a2ef6e17963261dfdb; marginal percentiles are not an individual ledger.

## Terminal distribution

![Terminal distribution](images/13_terminal_distribution.png)

Mixture plots equally weight the selected conditional scenarios; they are not a probability forecast.

## Real wealth cdf

![Real wealth cdf](images/14_real_wealth_cdf.png)

Mixture plots equally weight the selected conditional scenarios; they are not a probability forecast.

## Shortfall probability

![Shortfall probability](images/15_shortfall_probability.png)

Twenty highest modeled probabilities; exact binomial Monte Carlo intervals are in the summary table.

## Buy probability

![Buy probability](images/16_buy_probability.png)

Twenty highest modeled probabilities; exact binomial Monte Carlo intervals are in the summary table.

## Career

![Career](images/17_career.png)

Grouping mixes other scenario assumptions; this is not a causal estimate.

## Location

![Location](images/18_location.png)

Grouping mixes other scenario assumptions; this is not a causal estimate.

## Amanda work comparison

![Amanda work comparison](images/19_amanda_work_comparison.png)

Matched on all other scenario dimensions; negative values mean lower wealth when staying home.

## Company revenue and funding

![Company revenue and funding](images/20_company_revenue_and_funding.png)
...
![Company liquidity and unpaid compensation](images/21_company_liquidity_and_unpaid_compensation.png)

One retained, actual simulated path. This path is not the median of each component.

## Founder ownership through financing

![Founder ownership through financing](images/22_founder_ownership_through_financing.png)

One retained, actual simulated path. This path is not the median of each component.

## Exit proceeds and payment timing

![Exit proceeds and payment timing](images/23_exit_proceeds_and_payment_timing.png)

One retained, actual simulated path. This path is not the median of each component.

## Cumulative household income and costs

![Cumulative household income and costs](images/24_cumulative_household_income_and_costs.png)

One retained, actual simulated path. This path is not the median of each component.

## Minimum retirement age

![Minimum retirement age](images/25_minimum_retirement_age.png)
...
![Depletion combinations](images/26_depletion_combinations.png)
...
![Salary risk frontier](images/27_salary_risk_frontier.png)
